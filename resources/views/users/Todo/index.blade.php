                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center pb-4">
                                <button type="submit" data-bs-toggle="modal"
                                    data-bs-target="#ModalConfirmationDelete{{ $item->id }}" class="btn btn-danger">
                                    Hapus
                                </button>
                                <div class="modal" tabindex="-1" id="ModalConfirmationDelete{{ $item->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><b>Konfirmasi Hapus Todo</b></h5>
                                            ...
                                            <div class="modal-body text-center">
                                                <form action="{{ route('todo.destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <p>Apakah anda yakin mau menghapus todo ini?</p>
                                                ...
                                                <form action="{{ route('todo.update', $item->id) }}" method="post">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="tugas" value="{{ $item->tugas }}"
                                                            id="tugas" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggal_awal" class="form-label">Tanggal Awal</label>
                                                        <input type="date" name="tanggal_awal"
                                                            value="{{ $item->tanggal_awal }}" id="tanggal_awal"
                                                            class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="tanggal_akhir"
                                                            value="{{ $item->tanggal_akhir }}" id="tanggal_akhir"
                                                            class="form-control">
                                                    </div>
